...
public class starbucks_list extends AppCompatActivity {
    private ListView list;
    String[] name_list = new String[30];
    String[] price_list = new String[30];
    int [] draw = new int[30];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tmp = makeDataString(R.raw.starbucks_menu);
        makeClass(tmp);

        list = (ListView)findViewById(R.id.starbucks_list);

        CustomList adapter = new CustomList(starbucks_list.this);
